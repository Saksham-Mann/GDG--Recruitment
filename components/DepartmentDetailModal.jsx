      ...
      <DialogContent className="max-w-[95vw] sm:max-w-[85vw] md:max-w-[70vw] lg:max-w-[55vw] xl:max-w-[48vw] max-h-[90vh] overflow-y-auto rounded-3xl p-0 border border-border/70 shadow-2xl">
        ...
        <div className="relative w-full h-48 sm:h-60 overflow-hidden bg-muted">
          ...
          <div className="absolute bottom-4 left-6 sm:left-8 flex items-center gap-3">
            <div
              className="flex h-14 w-14 items-center justify-center rounded-2xl shadow-xl backdrop-blur-xl border border-white/25 text-white"
              style={{
                backgroundColor: toneColor || "#3b82f6",
                boxShadow: toneColor ? `0 6px 20px ${toneColor}50` : "0 6px 20px rgba(0,0,0,0.2)",
              }}
            >
              <IconComponent className="h-8 w-8 stroke-[2.2] text-white drop-shadow-md" style={{ color: "#ffffff", opacity: 1 }} />
            </div>
            <div>
              <Badge
                variant="outline"
